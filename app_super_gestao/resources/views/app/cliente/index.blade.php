...
@section('conteudo')
    ...
    <div class="conteudo-pagina">
        ...
        <div class="menu">
            <ul>
                <li><a href="{{ route('cliente.create') }}">Nova</a></li>
        ...
        <div class="informacao-pagina">
            ...
            <!--
                ...
                <br>
                {{ $clientes->firstItem() }} - Número do primeiro registros da página
                <br>
                {{ $clientes->lastItem() }} - Número do último registros da página
                <br>
                -->
                <br>
